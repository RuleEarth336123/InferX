#ifndef MODEL_H_QWEN2_
#define MODEL_H_QWEN2_
...
namespace model{
    ...
    public:
        explicit Qwen2Model(base::TokenizerType tokenizer_type,string token_path,string model_path,bool is_quant_model = false);
    ...
    private:
        ...
        std::unique_ptr<model::Qwen2layers> qwen_layers_;
